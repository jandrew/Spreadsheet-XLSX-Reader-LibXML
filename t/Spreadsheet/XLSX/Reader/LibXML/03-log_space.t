...
use Spreadsheet::XLSX::Reader::LogSpace v0.1;
use Spreadsheet::XLSX::Reader::Types v0.1;
my  ( 
...
lives_ok{
			...
			$test_instance = build_instance(
				...
				roles =>[ 'Spreadsheet::XLSX::Reader::LogSpace' ],
				log_space => 'Test',
			);
...
has_attribute_ok
			$test_instance, $_,
										"Check that Spreadsheet::XLSX::LogSpace has the -$_- attribute"
} 			@class_attributes;
map{
...
is			$Spreadsheet::XLSX::Reader::Types::log_space, 'Test::Types',
...
is			$Spreadsheet::XLSX::Reader::Types::log_space, 'New::Space::Types',
										"...and that the Types log_space was set accordingly";
explain 								"...Test Done";
done_testing();
