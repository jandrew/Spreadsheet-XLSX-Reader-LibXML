...
use version 0.77; our $VERSION = version->declare('v0.44.2');
...
I<his module is being replaced by L<Spreadsheet::Reader::ExcelXML>.  The L<bugs associated
...
slower for large files since it uses are pure perl parser.  On the other hand a fair amount of the TODO 
