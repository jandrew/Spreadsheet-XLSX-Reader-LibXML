...
=head4 change_boundary_flag( $Bool )
...
=head4 get_shared_string_position( $int )
...
=head4 get_format_position( $int, [$header] )
...
=head4 set_group_return_type( (instance|unformatted|value) )
