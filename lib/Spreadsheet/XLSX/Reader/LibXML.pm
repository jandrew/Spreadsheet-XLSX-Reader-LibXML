...
workbook.  They are also the ways to set how the workbook is read.  For information 
on how to retrieve data from the worksheets see the 
L<Worksheet|Spreadsheet::XLSX::Reader::LibXML> documentation.  For additional workbook 
...
B<Returns:> An instance of the L<Spreadsheet::XLSX::Reader::LibXML> class
...
B<Example:> using the implied 'next' worksheet;
	...
	while( my $worksheet = $workbook-E<gt>worksheet ){
		# Read the next worksheet
	}
